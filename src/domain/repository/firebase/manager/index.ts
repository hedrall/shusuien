...
export namespace FsManager {
  export class 棚<C extends Converter<Domainの棚>>
    implements FsManager<Domainの棚, C>
  {
    static _name = "棚";
  ...
  export class 鉢<C extends Converter<Domainの鉢>>
    implements FsManager<Domainの鉢, C>
  {
    static _name = "鉢";
  ...
  export class 履歴<C extends Converter<Domainの履歴>>
    implements FsManager<Domainの履歴, C>
  {
    static _name = "履歴";
