...
import { 履歴ID } from 'src/domain/entity/鉢/entity/履歴/index';
...
export abstract class Super履歴Base {
  id: 履歴ID | undefined;
  userId: UserId;
  ...
  protected constructor(props: Super履歴Base) {
    this.id = props.id;
...
export abstract class Super履歴 extends Super履歴Base {
  is灌水(this: Super履歴): this is _灌水履歴 {
    return this.内容.type === '灌水';
  }

  is成長の記録(this: Super履歴): this is _成長の記録 {
    return this.内容.type === '成長の記録';
  }

  is植替え(this: Super履歴): this is _植替え履歴 {
    return this.内容.type === '植替え';
  }

  constructor(props: Super履歴Base) {
    super(props);
  }
}
